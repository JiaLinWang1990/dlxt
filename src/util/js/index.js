...
let initChart = (targetEl, opts, isResize) => {
	...
	targetEl.setAttribute(
		"style",
		`width: ${width}; height: ${height};float: left;display: flex;justify-content: center;position:absolute;top:0;bottom:0;right:0;left:0;margin:auto;inset:unset;bottom:30px;`
	);
